...
<img  src="serparating-blobs-testset.png" />
Figure 2. As two identical clusters are separated by more and more distance, the largest value of the 'proportional gap probability vector' get larger and larger, indicating greater confidence in the cluster assignment.
